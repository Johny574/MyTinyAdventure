...
public class ItemStackPanel : PanelController
{
    ItemStackCommand _stack;
    Action _confirmAction;
    public ItemStackPanel(VisualTreeAsset panel_t, VisualElement root, bool dragable, AudioSource openaudio, AudioSource closeaudio) : base(panel_t, root, dragable, openaudio, closeaudio) {
