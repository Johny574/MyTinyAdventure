...
public class LocationManager : Singleton<LocationManager>
{
    ...
    protected override void Awake()
    {
        ...
        Nodes.Add("Graveyard", new Node("Graveyard"));
        ...
        Nodes["Forest1-1"].ConnectNode(Nodes["GnurksCave"]);

        Nodes["Forest1-1"].ConnectNode(Nodes["Shop"]);
        Nodes["Shop"].ConnectNode(Nodes["Forest1-1"]);

        Nodes["Forest1-1"].ConnectNode(Nodes["Forest1-2"]);
        Nodes["Forest1-2"].ConnectNode(Nodes["Forest1-1"]);

        Nodes["Forest1-1"].ConnectNode(Nodes["Forest1-3"]);
        Nodes["Forest1-3"].ConnectNode(Nodes["Forest1-1"]);

        Nodes["Forest1-1"].ConnectNode(Nodes["Forest1-4"]);
        Nodes["Forest1-4"].ConnectNode(Nodes["Forest1-1"]);
        
        Nodes["Forest1-4"].ConnectNode(Nodes["Graveyard"]);
        Nodes["Graveyard"].ConnectNode(Nodes["Forest1-4"]);
    }
